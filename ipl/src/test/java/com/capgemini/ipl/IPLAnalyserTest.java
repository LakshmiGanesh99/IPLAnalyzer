...
public class IPLAnalyserTest {
	...
	public void givenSortedOnBattingAverageBatsmenList_ShouldReturnBestAveragedBatsman() {
		try {
			...
			CSVIPLBatsmenRecords[] batsmenListCsv = new Gson().fromJson(sortedBatsmenJson,
					CSVIPLBatsmenRecords[].class);
	...
	public void givenSortedOnBowlingAverageBowlersList_ShouldReturnBestAveragedBowler() {
		try {
			...
			CSVIPLBowlersRecords[] bowlersListCsv = new Gson().fromJson(sortedBowlersJson,
					CSVIPLBowlersRecords[].class);
	...
	public void givenSortedOnBowlingEconomyBowlersList_ShouldReturnMostEconomicBowlerWith4wOr5w() {
		try {
			String sortedBowlersJson = new IPLAnalyser()
					.getSortedBowlersListOnBowlingStrikingRateWith4wOr5w(RIGHT_BOWLERS_CSV);
			CSVIPLBowlersRecords[] bowlersListCsv = new Gson().fromJson(sortedBowlersJson,
					CSVIPLBowlersRecords[].class);
			assertEquals("Alzarri Joseph", bowlersListCsv[0].player);
		} catch (Exception e) {
